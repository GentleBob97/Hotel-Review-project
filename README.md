...
Hotel_Reviews_Matlibplot.ipynb (ANALISI PANDAS + GRAFICI); 

Grafici Matlibplot Hotel_Reviews (CARTELLA IMMAGINI GRAFICI MATLIBPLOT);

Hotel_Reviews_DB&DATA.SQL (SCHEMA DATABASE + DATI INSERITI); 

databaseSQL.Hotel_Reviews.txt (COMANDI CREAZIONE DATABASE SU SQL);
